                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><a href="{{route('services.edit', $servicefeecategory->id)}}" class="btn btn-info">EDIT</a>
                                <a href="{{route('services.delete', $servicefeecategory->id)}}" class="btn btn-danger" id="delete">DELETE</a></td>
